...
FIELDS_CONFIG = [
    ...
    {"coord": (660, 978.5), "size": 24, "rotate": 1.7, "color": (40, 42, 55), "width": 20, "spacing": 12.5, "lines": 3}, # 5. Место рожд.
    {"coord": (500, 922.5), "size": 24, "rotate": 0.6, "color": (35, 38, 50)},     # 6. Пол
    {"coord": (535, 365), "size": 24, "rotate": 0.7, "color": (45, 45, 60), "width": 32, "spacing": 12.5, "lines": 3}, # 7. Кем выдан
