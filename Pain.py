...
FIELDS_CONFIG = [
    {"coord": (660, 750), "size": 32, "rotate": -1.3, "color": (40, 42, 55)},   # 1. Фамилия
    {"coord": (660, 860), "size": 32, "rotate": -1.2, "color": (40, 42, 55)},   # 2. Имя
    {"coord": (660, 874), "size": 32, "rotate": -1.2, "color": (40, 42, 55)},   # 3. Отчество
    {"coord": (710, 914), "size": 28, "rotate": -0.5, "color": (35, 38, 50)},   # 4. Дата рожд.
    {"coord": (660, 960), "size": 24, "rotate": -0.7, "color": (40, 42, 55), "width": 25}, # 5. Место рожд.
    {"coord": (500, 920), "size": 28, "rotate": -0.7, "color": (35, 38, 50)},   # 6. Пол
    {"coord": (546, 371), "size": 24, "rotate": -0.6, "color": (45, 45, 60), "width": 45}, # 7. Кем выдан
    {"coord": (357, 437), "size": 28, "rotate": -1.5, "color": (40, 40, 55)},   # 8. Дата выд.
    {"coord": (710, 430), "size": 30, "rotate": -1.2, "color": (40, 42, 55)},  # 9. Код подр.
    {"coord": (870, 880), "size": 42, "rotate": -91.0, "color": (150, 30, 30)}, # 10. Номер (НИЖНИЙ)
    {"coord": (860, 455), "size": 38, "rotate": -91.0, "color": (140, 30, 30)}    # 11. Номер (ВЕРХНИЙ)
]
