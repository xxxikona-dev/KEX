...
FIELDS_CONFIG = [
    {"coord": (660, 754.5), "size": 24, "rotate": 0.7, "color": (40, 42, 55)},   # 1. Фамилия
    {"coord": (660, 839), "size": 24, "rotate": 0.9, "color": (40, 42, 55)},     # 2. Имя
    {"coord": (660, 877.5), "size": 24, "rotate": 0.9, "color": (40, 42, 55)},     # 3. Отчество
    {"coord": (710, 917), "size": 24, "rotate": 0.9, "color": (35, 38, 50)},   # 4. Дата рожд.
    {"coord": (660, 970.5), "size": 24, "rotate": 0.7, "color": (40, 42, 55), "width": 25, "spacing": 11, "lines": 3}, # 5. Место рожд.
    {"coord": (500, 922.5), "size": 24, "rotate": 0.6, "color": (35, 38, 50)},     # 6. Пол
    {"coord": (535, 370), "size": 24, "rotate": 0.7, "color": (45, 45, 60), "width": 32, "spacing": 12, "lines": 3}, # 7. Кем выдан
    {"coord": (357, 439), "size": 24, "rotate": -0.5, "color": (40, 40, 55)},  # 8. Дата выд.
