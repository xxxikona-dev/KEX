...
FIELDS_CONFIG = [
    ...
    {"coord": (660, 960), "size": 24, "rotate": -0.2, "color": (40, 42, 55), "width": 25}, # 5. Место рожд.
    {"coord": (500, 920), "size": 24, "rotate": -0.7, "color": (35, 38, 50)},   # 6. Пол
    {"coord": (535, 371), "size": 24, "rotate": -0.2, "color": (45, 45, 60), "width": 45}, # 7. Кем выдан
    {"coord": (357, 437), "size": 24, "rotate": -1, "color": (40, 40, 55)},   # 8. Дата выд.
    {"coord": (710, 430), "size": 24, "rotate": -0.5, "color": (40, 42, 55)},  # 9. Код подр.
