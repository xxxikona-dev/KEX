...
FIELDS_CONFIG = [
    ...
    {"coord": (660, 999.5), "size": 24, "rotate": 1.7, "color": (40, 42, 55), "width": 20, "spacing": 15.8, "lines": 3}, # 5. Место рожд.
    {"coord": (500, 923.5), "size": 23, "rotate": 0.7, "color": (35, 38, 50)},     # 6. Пол
    {"coord": (535, 353.5), "size": 24, "rotate": 0.7, "color": (45, 45, 60), "width": 22, "spacing": 14.5, "lines": 3}, # 7. Кем выдан
