...
FIELDS_CONFIG = [
    {"coord": (660, 753.5), "size": 24, "rotate": 0.7, "color": (40, 42, 55)},   # 1. Фамилия
    {"coord": (660, 839), "size": 24, "rotate": 0.7, "color": (40, 42, 55)},     # 2. Имя
    {"coord": (660, 877), "size": 24, "rotate": 0.7, "color": (40, 42, 55)},     # 3. Отчество
    {"coord": (710, 916.5), "size": 24, "rotate": 0.7, "color": (35, 38, 50)},   # 4. Дата рожд.
    {"coord": (660, 962.5), "size": 24, "rotate": 0.7, "color": (40, 42, 55), "width": 25, "spacing": 11, "lines": 3}, # 5. Место рожд.
    {"coord": (500, 922), "size": 24, "rotate": 0.3, "color": (35, 38, 50)},     # 6. Пол
    {"coord": (535, 372), "size": 24, "rotate": 0.7, "color": (45, 45, 60), "width": 32, "spacing": 12, "lines": 3}, # 7. Кем выдан
    {"coord": (357, 438.5), "size": 24, "rotate": -0.5, "color": (40, 40, 55)},  # 8. Дата выд.
    {"coord": (710, 434), "size": 24, "rotate": -0.2, "color": (40, 42, 55)},    # 9. Код подр.
    {"coord": (870, 880), "size": 28, "rotate": -89.0, "color": (150, 30, 30)},  # 10. Номер (НИЖНИЙ)
